...
$limit = 12;
$start = ($page - 1) * $limit;
$searchText = trim(isset($_GET['text']) ? $_GET['text'] : null);
...
<div>
  <label>PRICE:</label>
  <input type="number" name="min_price" id="minPrice" placeholder="Min Price" style="margin-bottom: 0;">
<label style="margin: 10px 0;">TO</label>
